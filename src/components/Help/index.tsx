...
function Box(props: box) {
    ...
    return (
      <div className={"w-8 h-8 sm:w-10 sm:h-10 grid place-items-center p-0 m-0 font-bold text-lg sm:text-2xl " + state}>
        {props.value}
      </div>
    );
}
...
export default function Help(props: help) {

    return (
        <div className="absolute w-full h-full grid place-cente">
            <div
                className="shadow z-10 flex place-self-center flex-col rounded-xl bg-white p-5 pb-10 drop-shadow-3xl dark:bg-zinc-800 dark:text-white"
